...
def show_venue(venue_id):
  ...
  venue = Venue.query.get(venue_id).first_or_404()
...
def create_venue_submission():
  ...
  try: 
    ...
    venue = Venue(name=name, city=city, state=state, address=address, phone=phone, genres=genres, facebook_link=facebook_link, image_link=image_link, website=website)
